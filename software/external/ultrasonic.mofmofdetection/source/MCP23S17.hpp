...
private:
  ...
  void write8(uint8_t device_address, uint8_t reg_address, uint8_t data,
              uint8_t mask = 0xFF);
...
public:
  ...
  // if "output" is set to true, the MCP23S17 will write to the pin, otherwise
  // it will read from the pin
