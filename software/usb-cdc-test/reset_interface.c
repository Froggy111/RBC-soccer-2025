...
static const uint8_t desc_ms_os_20[] = {
    ...
    USBD_ITF_RPI_RESET, 0, U16_TO_U8S_LE(0x009C),
    ...
    U16_TO_U8S_LE(0x0028), // wPropertyDataType, wPropertyNameLength and
                           // PropertyName "DeviceInterfaceGUID" in UTF-16
    ...
    '{', 0, 'b', 0, 'c', 0, '7', 0, '3', 0, '9', 0, '8', 0, 'c', 0, '1', 0, '-',
    0, '7', 0, '3', 0, 'c', 0, 'd', 0, '-', 0, '4', 0, 'c', 0, 'b', 0, '7', 0,
    '-', 0, '9', 0, '8', 0, 'b', 0, '8', 0, '-', 0, '9', 0, '1', 0, '3', 0, 'a',
    0, '8', 0, 'f', 0, 'c', 0, 'a', 0, '7', 0, 'b', 0, 'f', 0, '6', 0, '}', 0,
    0, 0};
...
#endif
    rom_reset_usb_boot_extra(
        gpio, PICO_STDIO_USB_RESET_BOOTSEL_INTERFACE_DISABLE_MASK, active_low);
  }
}
#endif
