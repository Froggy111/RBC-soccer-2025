...
int main() {
    ...
    while (mode_controller::mode != mode_controller::Mode::EMERGENCY_STOP) {
        ...
        motors::command_motor_motion_controller(1, 5000);
        std::this_thread::sleep_for(std::chrono::milliseconds(1));
        motors::command_motor_motion_controller(2, 5000);
        std::this_thread::sleep_for(std::chrono::milliseconds(2));
        motors::command_motor_motion_controller(3, 5000);
        std::this_thread::sleep_for(std::chrono::milliseconds(3));
        motors::command_motor_motion_controller(4, 5000);
