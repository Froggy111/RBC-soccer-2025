...
OCP_H1    = (1 << 3),  // Overcurrent detected on high-side FET (short to GND) on OUT1
OCP_L1    = (1 << 2),  // Overcurrent detected on low-side FET (short to VM) on OUT1
OCP_H2    = (1 << 1),  // Overcurrent detected on high-side FET (short to GND) on OUT2
OCP_L2    = (1 << 0)   // Overcurrent detected on low-side FET (short to VM) on OUT2
};
